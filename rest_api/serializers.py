...
class ProductoSerializer(serializers.ModelSerializer):
    ...
    cantidadstock = serializers.CharField(source='cantidadstock.cantidad', read_only=True)
    class Meta:
        model = Producto
        fields = ('idProducto', 'idTipoProducto', 'nombreTipoProducto', 'descripcionTipoProducto', 'cantidadstock')